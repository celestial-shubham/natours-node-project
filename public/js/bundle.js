...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourID) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NOFqlSBmcnW8TJY7aG4VYfZJf9hENTn0Udu80wE67wKIZOC0MhH4YgUOBSXYkyY6v15HdmymuUEMnfAxgfwWsua00EYTyOShC'); // 1 GET CheckOut session from API
          _context.prev = 1;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // basically the event listener that trigger this evetlistener i.e book-tour
